      ...
      const poll = setInterval(async () => {
        ...
        try {
          ...
          if (hd.ok) {
            ...
            textEl.innerHTML = "更新完成！即将刷新…"; setTimeout(() => location.reload(), 2000); //：如果 service worker 没有触发 reload，10 秒后提示手动刷新
            setTimeout(() => {
              if (updateBanner.style.display !== "none") {
                textEl.innerHTML = "更新完成！请手动刷新面板。";
